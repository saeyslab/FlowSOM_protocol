...
# Cover suggestion
```{r}
agg <- read.FCS("Data/Preprocessed/aggregate.fcs")
fsom <- FlowSOM(input = agg,
                scale = FALSE,
                colsToUse = c("MHCII", "CD64", "FcERI", "CD161", "Ly-6G", "CD3", "CD19", "CD11c"),
                seed = 2021,
                nClus = 8,
                xdim = 8, ydim = 8)
saveRDS(fsom, "Figures/fsom_cover.rds")
...
ggsave(file = "Figures/fsom_cover.pdf", 
